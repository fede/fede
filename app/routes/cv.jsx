          ...
          <section className="mb-8">
            ...
            <div className="space-y-6">
              <CompanyHeader
                ...
                position="Senior Tech & Product lead"
                date="2022 - Present"
                badgeClasses="bg-blue-900 text-white"
              />
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                <li>
                  <b>Designed and applied a new organization</b> that would turn
                  the team into a domain of team to reduce repetition, tech
                  diversity and increase velocity.
                </li>
                <li>
                  Appointed different tech leads and product owners for the
                  different teams, while making sure that all teams are aligned
                  in architecture and tech adoption as the{" "}
                  <b>tech lead of tech leads (4 product teams)</b>.
                </li>
                <li>
                  Implemented cloud native solutions with <b>IaC</b> that allows
                  us to quickly recover from a disaster, prevent downtimes and{" "}
                  <b>increase traceability and security</b> of our changes.
                </li>
                <li>
                  <b>Drafted</b> the first version and <b>co-authored</b> the
                  final version of what would become the{" "}
                  <b>Engineering Handbook</b>. An onboarding guide for all
                  developers to easily align and agree on the ways of working,
                  api patterns, architecture and best practices. This played a
                  mayor role in aligning the commercial development and
                  operations in a single vision.
                </li>
                <li>
                  <b>Product owner</b> of a team building a react framework that
                  allows any other team in the company to build their own app
                  within, while having tests, monitoring, packaging, deploying,
                  user management and even a UI library streamlined with just
                  one command line{" "}
                  <b>reducing delivery time from 12 months to only 3 months</b>.
                </li>
                <li>
                ...
                <li>
                  Several on-site visits to the stations, testing new prototypes
                  and integrations with <b>IoT</b>. Surveying and testing own
                  prototypes.
                </li>
                <li>
                  <b>Architect of wifi onboard our aircrafts</b>. As we are
                  heading to the adoption of Starlink in our aircrafts, we are
                  also refreshing our offering while providing streaming content
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>
                  <b>Periodic 1-on-1</b>, constantly following up and assisting
                  in career growth and team health. Including other EMs.
                </li>
                <li>
                ...
                <li>
                  ...
                  and drafted the first toolkit to help streamline every years
                  organization.
                </li>
                <li>
                  <b>Designed and executed the division of our team</b> into two
                  (and eventually three) problem spaces that allowed the
                  developers to focus deeper on less things but still retaining
                  the big picture.
                </li>
                <li>
                  <b>Architecture</b> and development of the earn & burn system.
                  Accruing points for paid purchases, and gift cards unlocking
                  handling edge cases like refunds and <b>fraud prevention</b>.
                </li>
                <li>
                  Implemented a wide variety of AWS products to ensure
                  reliability, security, redundancy and also{" "}
                  <b>geographical distribution</b> since the reward program runs
                  in several countries around the globe.
                </li>
                <li>
                  <b>Member of the internal architecture group</b> that would
                  help and guide the teams with less expertise or that needed a
                  second opinion on their decision.
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>
                  <b>A/B testing</b> of new features and developments with our
                  passengers at different airports.
                </li>
                <li>
                  Run the <b>discovery and led the initial prototype</b> of what
                ...
                <li>
                  ...
                  Node.js, server side rendering with React, a GraphQL server
                  with multiple systems integrations such as Radixx.
                </li>
                <li>
